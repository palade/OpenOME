...
public class OpenOMEActionProvider extends AbstractContributionItemProvider {
	...
	protected IAction createAction(String actionId,
		...
		} else if (actionId.equals("EditIOPEAction")) {
			return new EditIOPEAction(workbenchPage);
		} else if (actionId.equals("ServiceDiscoveryNowAction")) {
			return new ServiceDiscoveryNowAction(workbenchPage);
		} else {
			return null;
		}
	}
	...
	protected IMenuManager createMenuManager(String menuId,
		...
		if (menuId.equals("DecompositionLineTypeMenu")) {
			...
			menu.add(createAction("ChangeToAndDecompositionAction",
					partDescriptor));
			menu.add(createAction("ChangeToOrDecompositionAction",
					partDescriptor));

			// adding a sub-submenu to change to contributions
			IMenuManager submenu = new ChangeTypeMenuManager("Contributions");
			submenu.add(createAction("ChangeToMakeContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToSomePlusContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToHelpContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToUnknownContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToHurtContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToSomeMinusContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToBreakContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToAndContributionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToOrContributionAction",
					partDescriptor));
			...
			// Adding the options to change to other decomposition types
			menu.add(createAction("ChangeToMakeContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToSomePlusContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToHelpContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToUnknownContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToHurtContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToSomeMinusContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToBreakContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToAndContributionAction",
					partDescriptor));
			menu.add(createAction("ChangeToOrContributionAction",
					partDescriptor));
			...
			submenu.add(createAction("ChangeToAndDecompositionAction",
					partDescriptor));
			submenu.add(createAction("ChangeToOrDecompositionAction",
					partDescriptor));
			...
			IMenuManager menu = new ChangeTypeMenuManager();
			menu.add(createAction("ChangeToIsAAssociationAction",
					partDescriptor));
			menu.add(createAction("ChangeToCoversAssociationAction",
					partDescriptor));
			menu.add(createAction("ChangeToIsPartOfAssociationAction",
					partDescriptor));
			menu.add(createAction("ChangeToOccupiesAssociationAction",
					partDescriptor));
			menu.add(createAction("ChangeToPlaysAssociationAction",
					partDescriptor));
			menu.add(createAction("ChangeToINSAssociationAction",
					partDescriptor));
			return menu;
		} else if (menuId.equals("IntentionGoalLabelTypeMenu")) {
			IMenuManager menu = new ChangeTypeMenuManager(
					"Set Qualitative Goal Label");
			menu.add(createAction("SetNoneLabelAction", partDescriptor));
			menu.add(createAction("SetSatisfiedLabelAction", partDescriptor));
			menu.add(createAction("SetWeaklySatisfiedLabelAction",
					partDescriptor));
