...
//        super.createButton((Composite)super.getDialogArea(), IDialogConstants.CANCEL_ID, "Cancel", false);
// 
//    }
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, IDialogConstants.OK_ID, "Set as candidate service",
				true);
