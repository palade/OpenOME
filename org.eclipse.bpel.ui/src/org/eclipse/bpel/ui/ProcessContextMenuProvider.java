...
import org.eclipse.bpel.ui.actions.ChangeColorToBlueAction;
import org.eclipse.bpel.ui.actions.ColorToGreenAction;
import org.eclipse.bpel.ui.actions.ColorToRedAction;
import org.eclipse.bpel.ui.actions.EditPartContextAction;
import org.eclipse.bpel.ui.actions.ColorToBlueAction;
...
//		menu.appendToGroup(GEFActionConstants.GROUP_UNDO, actionRegistry.getAction(ActionFactory.REDO.getId()));
		...
		MenuManager colorMenu = new MenuManager("Change Color");
		ColorToBlueAction b  = new ColorToBlueAction();
		ColorToGreenAction g  = new ColorToGreenAction();
		ColorToRedAction r  = new ColorToRedAction();
		
		colorMenu.add(b);
		colorMenu.add(g);
		colorMenu.add(r);
		
		menu.appendToGroup("COLOR", colorMenu);
	}
}