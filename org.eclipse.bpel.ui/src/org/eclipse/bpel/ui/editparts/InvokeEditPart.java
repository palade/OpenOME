...
public class InvokeEditPart extends LeafEditPart implements ILayoutAware{
	...
	public void refreshVisuals() {
		...
		//System.out.println("in invoke refreshvisuals---------------------------------------------");
		//(this.getMainActivityFigure()).setBackgroundColor(new Color(null, ((ActivityImpl)this.getModel()).getColor()));
		//System.out.println(this.getFigure());
