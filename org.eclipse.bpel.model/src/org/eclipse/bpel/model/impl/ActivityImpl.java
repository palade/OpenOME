...
//			return;
		...
		eNotify(new ENotificationImpl(this, Notification.SET,
				BPELPackage.ACTIVITY_COLOR, old, color));
		//这个事件被框架捕获后，调用editPart，执行到activityEditPart的refreshvisual方法
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case BPELPackage.ACTIVITY__SOURCES:
			return getSources();
		case BPELPackage.ACTIVITY_COLOR://zhong
			return getColor();
		}
	...
	public void eUnset(int featureID) {
		...
		case BPELPackage.ACTIVITY__SOURCES:
			...
			return;
		case BPELPackage.ACTIVITY_COLOR://zhong ：设置默认值白色
	...
	public boolean eIsSet(int featureID) {
		...
		case BPELPackage.ACTIVITY__SOURCES:
			return sources != null;
		case BPELPackage.ACTIVITY_COLOR://zhong：判断是否被设置过
			return !color.equals(new RGB(255,255,255));
		}
