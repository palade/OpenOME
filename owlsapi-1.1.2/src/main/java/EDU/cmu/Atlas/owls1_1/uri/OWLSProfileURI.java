...
public class OWLSProfileURI {
 ...
 //   public static final String actorDefault = "http://www.daml.org/services/owl-s/1.1/ActorDefault.owl";
    ...
    public static final String actorDefault = "http://localhost:8080/juddiv3/owl-s/1.1/ActorDefault.owl";
...
//    public static final String additionalParameter = "http://www.daml.org/services/owl-s/1.1/ProfileAdditionalParameters.owl";
    ...
    public static final String additionalParameter = "http://localhost:8080/juddiv3/owl-s/1.1/ProfileAdditionalParameters.owl";
