...
//    public static String Grounding = "http://www.daml.org/services/owl-s/1.1/Grounding.owl";

	public static String Grounding = "http://localhost:8080/juddiv3/owl-s/1.1/Grounding.owl";
