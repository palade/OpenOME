...
public class SupportsDialog extends Dialog {
	public Tree tree = null;
	public String name = null;
	public SupportsDialog(Shell parentShell) {
		super(parentShell);
	...
	public Control createDialogArea(Composite parent) {
		...
		item1.setText("service:supports");
		
		TreeItem item2 = new TreeItem(item1,SWT.NONE);
		item2.setText("grounding:Grounding");
		
		TreeItem item3 = new TreeItem(item2,SWT.NONE);
		item3.setText("grounding:WsdlGrounding");
		return parent;
		}
