...
public class RequestInfo implements org.apache.thrift.TBase<RequestInfo, RequestInfo._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final org.apache.thrift.protocol.TField OWLS_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("owlsInfo", org.apache.thrift.protocol.TType.LIST, (short)1);
  ...
  public List<TaskInfo> owlsInfo; // optional
  public GRLInfo grlinfo; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    OWLS_INFO((short)1, "owlsInfo"),
  ...
  private _Fields optionals[] = {_Fields.OWLS_INFO,_Fields.GRLINFO};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.OWLS_INFO, new org.apache.thrift.meta_data.FieldMetaData("owlsInfo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public RequestInfo(RequestInfo other) {
    if (other.isSetOwlsInfo()) {
      List<TaskInfo> __this__owlsInfo = new ArrayList<TaskInfo>();
      for (TaskInfo other_element : other.owlsInfo) {
        __this__owlsInfo.add(new TaskInfo(other_element));
      }
      this.owlsInfo = __this__owlsInfo;
    }
  ...
  public int getOwlsInfoSize() {
    return (this.owlsInfo == null) ? 0 : this.owlsInfo.size();
  }

  public java.util.Iterator<TaskInfo> getOwlsInfoIterator() {
    return (this.owlsInfo == null) ? null : this.owlsInfo.iterator();
  }

  public void addToOwlsInfo(TaskInfo elem) {
    if (this.owlsInfo == null) {
      this.owlsInfo = new ArrayList<TaskInfo>();
    }
    this.owlsInfo.add(elem);
  }

  public List<TaskInfo> getOwlsInfo() {
    return this.owlsInfo;
  }

  public RequestInfo setOwlsInfo(List<TaskInfo> owlsInfo) {
    this.owlsInfo = owlsInfo;
    return this;
  }

  public void unsetOwlsInfo() {
    this.owlsInfo = null;
  }

  /** Returns true if field owlsInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetOwlsInfo() {
    return this.owlsInfo != null;
  }

  public void setOwlsInfoIsSet(boolean value) {
    if (!value) {
      this.owlsInfo = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OWLS_INFO:
      if (value == null) {
        ...
        setOwlsInfo((List<TaskInfo>)value);
      }
      break;
  ...
  public boolean equals(RequestInfo that) {
    ...
    boolean this_present_owlsInfo = true && this.isSetOwlsInfo();
    boolean that_present_owlsInfo = true && that.isSetOwlsInfo();
    if (this_present_owlsInfo || that_present_owlsInfo) {
      if (!(this_present_owlsInfo && that_present_owlsInfo))
        return false;
      if (!this.owlsInfo.equals(that.owlsInfo))
        return false;
    }
  ...
  public int compareTo(RequestInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetOwlsInfo()).compareTo(typedOther.isSetOwlsInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOwlsInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.owlsInfo, typedOther.owlsInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class RequestInfoStandardScheme extends StandardScheme<RequestInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.owlsInfo = new ArrayList<TaskInfo>(_list72.size);
                for (int _i73 = 0; _i73 < _list72.size; ++_i73)
                {
                  TaskInfo _elem74; // required
                  _elem74 = new TaskInfo();
                  _elem74.read(iprot);
                  struct.owlsInfo.add(_elem74);
                }
                iprot.readListEnd();
              }
              struct.setOwlsInfoIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RequestInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.owlsInfo != null) {
        if (struct.isSetOwlsInfo()) {
          oprot.writeFieldBegin(OWLS_INFO_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.owlsInfo.size()));
            for (TaskInfo _iter75 : struct.owlsInfo)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class RequestInfoTupleScheme extends TupleScheme<RequestInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RequestInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOwlsInfo()) {
        {
          oprot.writeI32(struct.owlsInfo.size());
          for (TaskInfo _iter76 : struct.owlsInfo)
          {
            _iter76.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.owlsInfo = new ArrayList<TaskInfo>(_list77.size);
          for (int _i78 = 0; _i78 < _list77.size; ++_i78)
          {
            TaskInfo _elem79; // required
            _elem79 = new TaskInfo();
            _elem79.read(iprot);
            struct.owlsInfo.add(_elem79);
          }
        }
        struct.setOwlsInfoIsSet(true);
      }
