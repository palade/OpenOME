...
public class ServiceDiscoverer {
  ...
  public interface Iface {
    ...
    public ResponseInfo getServices(List<RequestInfo> requestInfoList) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getServices(List<RequestInfo> requestInfoList, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getServices_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public ResponseInfo getServices(List<RequestInfo> requestInfoList) throws org.apache.thrift.TException
    {
      send_getServices(requestInfoList);
      return recv_getServices();
    }

    public void send_getServices(List<RequestInfo> requestInfoList) throws org.apache.thrift.TException
    {
      getServices_args args = new getServices_args();
      args.setRequestInfoList(requestInfoList);
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getServices(List<RequestInfo> requestInfoList, org.apache.thrift.async.AsyncMethodCallback<getServices_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getServices_call method_call = new getServices_call(requestInfoList, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getServices_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public getServices_call(List<RequestInfo> requestInfoList, org.apache.thrift.async.AsyncMethodCallback<getServices_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getServices<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getServices_args> {
      ...
      public getServices_result getResult(I iface, getServices_args args) throws org.apache.thrift.TException {
        getServices_result result = new getServices_result();
        result.success = iface.getServices(args.requestInfoList);
        return result;
      }
    }
  ...
  public static class getServices_args implements org.apache.thrift.TBase<getServices_args, getServices_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField REQUEST_INFO_LIST_FIELD_DESC = new org.apache.thrift.protocol.TField("requestInfoList", org.apache.thrift.protocol.TType.LIST, (short)1);
    ...
    public List<RequestInfo> requestInfoList; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      REQUEST_INFO_LIST((short)1, "requestInfoList");
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST_INFO_LIST, new org.apache.thrift.meta_data.FieldMetaData("requestInfoList", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getServices_args(getServices_args other) {
      if (other.isSetRequestInfoList()) {
        List<RequestInfo> __this__requestInfoList = new ArrayList<RequestInfo>();
        for (RequestInfo other_element : other.requestInfoList) {
          __this__requestInfoList.add(new RequestInfo(other_element));
        }
        this.requestInfoList = __this__requestInfoList;
      }
    }
    ...
    @Override
    public void clear() {
      this.requestInfoList = null;
    }

    public int getRequestInfoListSize() {
      return (this.requestInfoList == null) ? 0 : this.requestInfoList.size();
    }

    public java.util.Iterator<RequestInfo> getRequestInfoListIterator() {
      return (this.requestInfoList == null) ? null : this.requestInfoList.iterator();
    }

    public void addToRequestInfoList(RequestInfo elem) {
      if (this.requestInfoList == null) {
        this.requestInfoList = new ArrayList<RequestInfo>();
      }
      this.requestInfoList.add(elem);
    }
    ...
    public getServices_args setRequestInfoList(List<RequestInfo> requestInfoList) {
      this.requestInfoList = requestInfoList;
      return this;
    }

    public void unsetRequestInfoList() {
      this.requestInfoList = null;
    }

    /** Returns true if field requestInfoList is set (has been assigned a value) and false otherwise */
    public boolean isSetRequestInfoList() {
      return this.requestInfoList != null;
    }

    public void setRequestInfoListIsSet(boolean value) {
      if (!value) {
        this.requestInfoList = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST_INFO_LIST:
        if (value == null) {
          unsetRequestInfoList();
        } else {
          setRequestInfoList((List<RequestInfo>)value);
        }
        break;
    ...
    public boolean equals(getServices_args that) {
      ...
      boolean this_present_requestInfoList = true && this.isSetRequestInfoList();
      boolean that_present_requestInfoList = true && that.isSetRequestInfoList();
      if (this_present_requestInfoList || that_present_requestInfoList) {
        if (!(this_present_requestInfoList && that_present_requestInfoList))
          return false;
        if (!this.requestInfoList.equals(that.requestInfoList))
          return false;
      }
    ...
    public int compareTo(getServices_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetRequestInfoList()).compareTo(typedOther.isSetRequestInfoList());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetRequestInfoList()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.requestInfoList, typedOther.requestInfoList);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      if (this.requestInfoList == null) {
        ...
        sb.append(this.requestInfoList);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getServices_argsStandardScheme extends StandardScheme<getServices_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.requestInfoList = new ArrayList<RequestInfo>(_list98.size);
                  for (int _i99 = 0; _i99 < _list98.size; ++_i99)
                  {
                    RequestInfo _elem100; // required
                    _elem100 = new RequestInfo();
                    _elem100.read(iprot);
                    struct.requestInfoList.add(_elem100);
                  }
                  iprot.readListEnd();
                }
                struct.setRequestInfoListIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getServices_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.requestInfoList != null) {
          oprot.writeFieldBegin(REQUEST_INFO_LIST_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.requestInfoList.size()));
            for (RequestInfo _iter101 : struct.requestInfoList)
            {
    ...
    private static class getServices_argsTupleScheme extends TupleScheme<getServices_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getServices_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetRequestInfoList()) {
          optionals.set(0);
        }
        oprot.writeBitSet(optionals, 1);
        if (struct.isSetRequestInfoList()) {
          {
            oprot.writeI32(struct.requestInfoList.size());
            for (RequestInfo _iter102 : struct.requestInfoList)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.requestInfoList = new ArrayList<RequestInfo>(_list103.size);
            for (int _i104 = 0; _i104 < _list103.size; ++_i104)
            {
              RequestInfo _elem105; // required
              _elem105 = new RequestInfo();
              _elem105.read(iprot);
              struct.requestInfoList.add(_elem105);
            }
          }
          struct.setRequestInfoListIsSet(true);
        }
