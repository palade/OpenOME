...
/**
 * @author jenhork This class is used to handle the evaluation menu function.
 *         This one handles the interactive qualitative reasoning menu.
 */
public class InteractiveQualReasonerHandler extends ReasonerHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		// Command addIntentionsToAlternative = new
		// AddIntentionsToAlternativeCommand(alt, intentionsList, mi);
		...
		// // Get the HJ View
		// hj = (HumanJudgmentsView)
		// PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(HumanJudgmentsView.ID);
		...
		// try {
		// // open the AlternativesView, if already opened just give the focus
		// to it
		// PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(AlternativesView.ID);
		// // Get the Alternates View
		// av = (AlternativesView)
		// PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView(AlternativesView.ID);
		// } catch (PartInitException e) {
		// // Shouldn't happen...
