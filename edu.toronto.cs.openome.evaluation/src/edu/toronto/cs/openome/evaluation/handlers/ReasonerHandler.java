...
public class ReasonerHandler implements IHandler {
	...
	/**
	 * @author jenhork The Reasoner needs a modelImpl and we are going to get
	 *         it. Most of this code is copied of Yijun and Neil's Versioning
	 *         code. I'm not entirely sure how it works, but it seems to work.
	 */
	...
	/**
	 * @author jenhork This is an important somethingorrather that is needed to
	 *         get both the modelImplementation and the command stack.
	 */
	 ...
	 * @param message
	 */
	protected void showMessage(String title, String message, Shell shell) {
