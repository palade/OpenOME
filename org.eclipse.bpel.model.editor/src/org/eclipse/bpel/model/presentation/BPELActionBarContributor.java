...
/**
 * This is the action bar contributor for the BPEL model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPELActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction refreshViewerAction = new Action(
			BpelEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	 ...
	 * @generated
	 */
	public BPELActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("bpel-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("bpel-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				BpelEditorPlugin.INSTANCE.getString("_UI_BPELEditor_menu"), "org.eclipse.bpel.modelMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
