...
import org.bflow.toolbox.addons.interfaces.IAttributeAdjustComponent;
import org.bflow.toolbox.addons.interfaces.IMitammMessage;
import org.bflow.toolbox.addons.utils.AttributeAdjustMessage;
import org.bflow.toolbox.addons.utils.ImplementationProvider;
...
public class AttributeAdjustComponent implements IAttributeAdjustComponent {
	...
	private List<IMitammMessage> consoleLines;
	...
	public void invoke() throws ComponentException {
		try {
			...
			for (IMitammMessage mm : consoleLines) {
	...
	public void transformInput(Object inputSource) throws ComponentException {
		...
		if (!l.isEmpty()) {
			...
			if (!(o instanceof IMitammMessage))
				throw new ComponentException("information class is not known!");
		}

		this.consoleLines = (List<IMitammMessage>) l;
